...
const account1 = {
  ...
  movementsDates: [
    ...
    '2023-04-03T23:36:17.929Z',
    '2023-04-04T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
// console.log(Number.parseInt('fy30px', 10));
...
// console.log(8 ** (1 / 3)); // cubicroot

// console.log(Math.max(5, 18, '23', 11, 2)); // max nr in a nr arr  // these do type coercion
// console.log(Math.min(5, 18, 23, 11, 2)); // min nr in a nr arr
...
// // Rounding Integers
// console.log(Math.trunc(23.3)); // cuts decimal part of numbers
...
// console.log(new Date('Apr 05 2023 15:12:22'));
...
// console.log(future.toISOString()); // Convert a date into a string to be stored somewhere
